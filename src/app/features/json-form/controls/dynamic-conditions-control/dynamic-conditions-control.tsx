  ...
  return (
    <div className="p-2 border border-[var(--wb-conditions-form-border-color)] rounded-[var(--wb-conditions-form-border-radius)]">
      ...
      <ControlWrapper {...props} uischema={{ ...props.uischema, label: "Dependencies" }}>
        <Textarea disabled={!enabled} value={dependencies.join(" ")} onClick={openEditorModal} />
        <span className="ax-public-p10 py-1 px-2 rounded bg-[var(--wb-conditions-form-tag-bg-color)] mr-auto">
          {data.length} total
        </span>
      </ControlWrapper>
    </div>
