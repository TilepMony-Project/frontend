...
const TEMPLATE_DISPLAY_DATA: Record<string, { shortDescription: string }> = {
  "treasury-fx-hedging": {
    shortDescription: "Diversify treasury funds into a basket of USD + Euro assets",
  },
  "cross-border-treasury-transfer": {
    shortDescription: "Multi-branch IDR→USD treasury flow with yield allocation",
  },
  "supply-chain-escrow": {
    shortDescription: "Yield-bearing escrow that releases principal + interest on delivery",
  },
  "revenue-split-tax": {
